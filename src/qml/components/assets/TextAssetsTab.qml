...
// Text tab: manual text/subtitle clips plus auto-caption (whisper) controls.
Item {
    id: root

    // The whole page scrolls, so short panel heights no longer clip
    // whisper/auto-caption controls below the fold.
    Flickable {
        anchors.fill: parent
        contentWidth: width
        ...
        Column {
            ...
            // Width available inside the Column. Was open-coded as
